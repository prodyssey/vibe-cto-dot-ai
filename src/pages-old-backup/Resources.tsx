...
export default function Resources() {
  ...
  return (
    <>
      <SEO
        title="Resources - Learn AI Development | VibeCTO.ai"
        description="Free resources, guides, and insights on AI development, vibe coding, vibe coded MVP building, and scaling digital products. Learn from real-world experience."
        canonicalUrl="https://vibecto.ai/resources"
        keywords="AI development resources, Augmented engineering, Agentic Engineering, tech guides, vibe coding, vibe coding MVP tutorials, startup technology, development best practices"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: "VibeCTO.ai Resources",
          description: "Collection of AI development resources and guides",
