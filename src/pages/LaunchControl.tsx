  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://vibecto.ai/launch-control"
        keywords="CTO services, tech scaling, product scaling, engineering leadership, AI development team, fractional CTO"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "Service",
          name: "Launch Control - Tech Scaling Service",
          description:
            "Expert CTO guidance and AI-augmented engineering for scaling vibe coded products",
          provider: {
            "@type": "Organization",
            name: "VibeCTO.ai",
          },
