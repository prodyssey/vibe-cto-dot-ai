...
import { Zap, Code, Rocket, CheckCircle, ArrowRight, Clock, Users, Target } from "lucide-react";
...
const Ignition = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Leverage the latest AI tools to accelerate your coding workflow"
    },
    {
      icon: Target,
      title: "Market Validation",
      description: "Get your MVP in front of users quickly to validate your ideas"
    },
    {
      icon: Users,
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Spark your vibe coding journey. Learn to build and ship faster than ever before 
              with AI-powered development tools and proven methodologies.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Get the foundation you need to build and ship products at the speed of thought.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 backdrop-blur-sm border border-white/20 rounded-3xl p-12">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Join thousands of developers who've accelerated their careers with vibe coding.
              </p>
