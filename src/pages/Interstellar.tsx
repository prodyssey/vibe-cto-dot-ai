...
import { Rocket, Users, Cpu, BarChart3, ArrowRight, Sparkles, Shield, Clock } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Deploy specialized AI agents across your development workflow"
    },
    {
      icon: BarChart3,
      title: "10x Velocity",
      description: "Ship features faster while maintaining code quality and standards"
    },
    {
      icon: Shield,
      title: "Enterprise Ready",
      description: "Secure, scalable solutions that integrate with your existing infrastructure"
    },
    {
      icon: Users,
      title: "Team Transformation",
      description: "Upskill your entire team with cutting-edge AI development practices"
    }
  ];

  const benefits = [
    "Reduce development cycles from months to weeks",
    "Automate repetitive tasks and code reviews",
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Take your team to light speed. Transform your product development with 
              AI agents that amplify your team's capabilities and accelerate delivery.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Leverage battle-tested strategies to integrate AI agents into your existing workflows.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center space-x-4 p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:border-white/20 transition-all duration-300">
        ...
        <section className="py-20 px-6 bg-black/20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                We work with your team to implement AI agents seamlessly into your workflow.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="bg-white/5 backdrop-blur-sm border-white/10">
                <CardHeader>
                  ...
                  <CardTitle className="text-white text-xl">Discovery & Assessment</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">
                    We analyze your current development processes and identify high-impact opportunities for AI integration.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10">
                <CardHeader>
                  ...
                  <CardTitle className="text-white text-xl">Implementation & Training</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">
                    Deploy custom AI agents tailored to your tech stack while training your team on best practices.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10">
                <CardHeader>
                  ...
                  <CardTitle className="text-white text-xl">Scale & Optimize</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">
                    Continuously improve and expand AI agent capabilities based on real-world results and feedback.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 backdrop-blur-sm border border-white/20 rounded-3xl p-12">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Join leading teams who've transformed their product development with AI agents.
              </p>
