          ...
          <div className="space-y-8">
            ...
            {showTerminal && (
              <div className="bg-gray-900/80 backdrop-blur-sm border border-cyan-500/50 rounded-lg p-6 font-mono text-sm animate-fadeIn">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-4 text-gray-400">MISSION_CONTROL_v2.0</span>
                </div>
                
                <div className="space-y-2 text-cyan-300">
                  <p className="animate-typewriter">{'>'} System Status: OPERATIONAL</p>
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Now it's time to reach escape velocity. Launch Control provides the technical infrastructure, 
                team augmentation, and strategic guidance to scale your successful prototype into a 
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-400">10x capacity improvements</p>
              </div>
              
              <div className="bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-6 text-center">
                <Zap className="w-8 h-8 text-cyan-400 mx-auto mb-3" />
                <h3 className="text-lg font-semibold text-white mb-2">Rapid Deployment</h3>
                <p className="text-sm text-gray-400">Ship features 3x faster</p>
              </div>
