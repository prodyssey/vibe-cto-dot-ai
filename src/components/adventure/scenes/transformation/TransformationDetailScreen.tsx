...
const TRANSFORMATION_SCENE: SceneType = {
  ...
  description: "Where teams shed their limitations and emerge better than ever",
  backgroundClass:
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-900/60 backdrop-blur-sm border border-purple-500/50 rounded-lg p-6 animate-fadeIn">
              ...
              <div className="space-y-2 text-purple-300 font-mono text-sm">
                <p className="animate-typewriter">
                  {">"} Analyzing team DNA structure...
                </p>
                <p
                  className="animate-typewriter"
                  style={{ animationDelay: "1s" }}
                >
                  {">"} Detecting evolution potential...
                </p>
                <p
                  className="animate-typewriter"
                  style={{ animationDelay: "2s" }}
                >
                  {">"} Transformation capacity: EXCEPTIONAL
                </p>
                <p
                  className="animate-typewriter"
                  style={{ animationDelay: "3s" }}
                >
                  {">"} Metamorphosis chambers ready for activation
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-purple-500/30 rounded-lg p-6 text-center group hover:scale-105 transition-transform">
                ...
                <p className="text-sm text-gray-400">
                  Multiply your development capacity
                </p>
              </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-purple-500/30 rounded-lg p-6 text-center group hover:scale-105 transition-transform">
                ...
                <p className="text-sm text-gray-400">
                  Uncover bottlenecks and optimize for customer value
                </p>
              </div>
            </div>
