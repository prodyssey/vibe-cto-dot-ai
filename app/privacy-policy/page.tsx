          ...
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm border border-white/20 rounded-3xl p-8 md:p-12">
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <div className="space-y-6 text-gray-300">
                ...
                <h2 className="text-2xl font-bold text-white mb-4 mt-8">Interpretation and Definitions</h2>

                <h3 className="text-xl font-bold text-white mb-4 mt-6">Interpretation</h3>
                <p className="text-lg leading-relaxed mb-4">
                  The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                </p>

                <h3 className="text-xl font-bold text-white mb-4 mt-6">Definitions</h3>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <ul className="list-disc pl-8 mb-4 space-y-2">
                  ...
                  <li>
                    <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to VibeCTO.ai.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Website</strong> refers to VibeCTO.ai, accessible from <a href="https://vibecto.ai" className="text-purple-300 hover:text-purple-100 underline">https://vibecto.ai</a>
                  </li>
                  <li>
                ...
                <h2 className="text-2xl font-bold text-white mb-4 mt-8">Collecting and Using Your Personal Data</h2>

                <h3 className="text-xl font-bold text-white mb-4 mt-6">Types of Data Collected</h3>

                <h4 className="text-lg font-bold text-white mb-4 mt-6">Personal Data</h4>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h4 className="text-lg font-bold text-white mb-4 mt-6">Usage Data</h4>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h4 className="text-lg font-bold text-white mb-4 mt-6">Tracking Technologies and Cookies</h4>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-4 mt-6">Use of Your Personal Data</h3>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-4 mt-6">Retention of Your Personal Data</h3>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-4 mt-6">Transfer of Your Personal Data</h3>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-4 mt-6">Delete Your Personal Data</h3>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-4 mt-6">Disclosure of Your Personal Data</h3>

                <h4 className="text-lg font-bold text-white mb-4 mt-6">Business Transactions</h4>
                <p className="text-lg leading-relaxed mb-4">
                  If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                </p>

                <h4 className="text-lg font-bold text-white mb-4 mt-6">Law enforcement</h4>
                <p className="text-lg leading-relaxed mb-4">
                  Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                </p>

                <h4 className="text-lg font-bold text-white mb-4 mt-6">Other legal requirements</h4>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-4 mt-6">Security of Your Personal Data</h3>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <h2 className="text-2xl font-bold text-white mb-4 mt-8">Links to Other Websites</h2>
                <p className="text-lg leading-relaxed mb-4">
                ...
                <ul className="list-disc pl-8 mb-4">
                  <li>By visiting this page on our website: <a href="/contact" className="text-purple-300 hover:text-purple-100 underline">/contact</a></li>
                </ul>
              </div>
            </div>
          </div>
